...
echo '[0/1] Downloading and installing c++ runtime patch, you mightl be prompted to go through installation, just click through it. [⟱]'
...
echo '[1/1] eveyrthing should be up and running! [◌𝨙]'
echo 'done!'
